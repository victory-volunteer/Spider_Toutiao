// var window = this; //不可以这样写, 会报错
var window = global;

// 在页面源码上添加条件断点(A == 'referrer')后, 且必须清除缓存和cookie后才可以断住
window.document = {
	referrer:''
};

window.location = {
    href: 'https://www.toutiao.com/?wid=1676011076375',
    protocol: 'https:'
}
...
// 在之前获取浏览器环境中发现，在出_signature之前，获取过一次cookie，所以我们要加上cookie才可以（到目标站点获取）
// 据前辈介绍signature长短和cookie的长度有关，所以打上条件断点，然后我们再补个cookie，而且document.cookie的位置得往后放，否则可能被删除清空什么的
// 注意cookie添加的位置，如果你放的最上面，中间的js有可能会删除或者改变cookie的值
// 这里的cookie必须是页面全部加载完成后最终的cookie, 否则会不起作用
document.cookie = '__ac_nonce=063e5e7950047ae0081b; msToken=VHXCCDo_1Ug7IO58upOyMh3E6sHkKy8YRi8qP_CLE4lpUyCxiefoFfiQ6HMf-Mh1BgDhaz50jWGAChgbW1GB3RYt7WhSsLwWXCvx8rehnUo=; __ac_signature=_02B4Z6wo00f01KM1.ywAAIDAIzcFbomOWQCjFfuAAEstde; ttcid=d47eaff32a2042de8d5d0f17c4901a9231; local_city_cache=%E5%8C%97%E4%BA%AC; csrftoken=54523d980e74f2c02ae85ed53dde6b15; s_v_web_id=verify_ldy6f1rj_VMy2c0Yt_RGfY_4nXG_AFKX_TNyXdpD2PKLb; tt_scid=T2P9FgGsCxea-64ASWKQQqMT4jpHmhOh08kcqLfBbJUypUbJ0tyj6o25ThGyLQjz2665'
...
function get_signature(){
    ...
    // return window.byted_acrawler.sign.call(n, o);
    // 等价于下方这条语句
